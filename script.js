...
function openServiceModal(card) { const detail = serviceDetails[card.dataset.service]; if (!detail) return; modalTrigger = card; const sourceImage=card.querySelector("img"),modalImage=document.getElementById("serviceModalImage");if(sourceImage&&modalImage){modalImage.src=sourceImage.src;modalImage.alt=sourceImage.alt} document.getElementById("serviceModalKicker").textContent = detail.kicker; document.getElementById("serviceModalTitle").textContent = detail.title; document.getElementById("serviceModalSummary").textContent = detail.summary; document.getElementById("serviceModalAbout").textContent = detail.about; document.getElementById("serviceModalPrepare").textContent = detail.prepare; const list = document.getElementById("serviceModalExpect"); list.replaceChildren(); detail.expect.forEach(item => { const li = document.createElement("li"); li.textContent = item; list.append(li); }); document.getElementById("serviceModalBook").dataset.service = card.dataset.service; serviceModal.hidden = false; document.body.classList.add("modal-open"); modalPanel.focus(); }
